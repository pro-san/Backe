...
import { MongoDbModal } from '../database/MongoDbModal';
  ...
  return (
    <header className="sticky top-0 z-20 h-14 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xs border-b border-slate-200 dark:border-slate-800 px-4 flex items-center justify-between no-print">
      ...
      <div className="flex items-center gap-2">
        {/* MongoDB Database Status Indicator & Config Button */}
        <button
        ...
        >
          ...
          <span className="font-semibold">{dbStatus?.connected ? 'Connected' : 'Active'}</span>
          <span
      ...
      {/* MongoDB Database Status & Configuration Dialog */}
      <MongoDbModal
        isOpen={dbModalOpen}
